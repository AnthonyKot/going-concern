...
fetches the documents and confirms it. The eight published chapters currently carry **300 verified
claims** against thirty-one sources. PDF sources are converted with `pdftotext` before matching; if
...
and 8 are published, 300 claims across the eight; 20 to go.
