...
fetches the documents and confirms it. The six published chapters currently carry **186 verified
claims** against twenty-five sources. PDF sources are converted with `pdftotext` before matching; if
...
published, 186 claims across the six; 22 to go.
